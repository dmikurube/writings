...
年に一度、毎年お正月の 1 月に開催で、年明けの 2025 年には第 66 回の開催をむかえます。

えっ、年に一度なのに、第 66 回?  そう、プログラミング・シンポジウムの第 1 回は、いまから 60 年以上も前の 1960 年 (昭和 35 年) だったそうです。
...
プロシンは学会方面のイベントですが、学術系の研究職ではなく企業でソフトウェア・エンジニアをやっている筆者は、いまプロシンの幹事団の一人をやってもいます。 [^kanji]

[^kanji]: 筆者は、この第 66 回でようやく幹事卒業の予定です。プロシンの幹事は持ち回りで、引き受けると通常は 4 年間くらい務めるのですが、コロナ禍で運営のやりかたが変わったり引き継ぎが難しかったりした影響で、延長戦をやっていました。
...
いわゆる「査読」もないため、大学の人にとっては学術的な「成果」になるわけでもありません。だというのに年明けもはよから、楽しみのためにみんな伊豆箱根まで毎年のように集まってくる、といえば気分が伝わるでしょうか。 [^shinnenkai]
...
過去には 200 人以上が参加したこともありましたが、ここ 10 年くらいの参加人数としては 70 人前後で落ち着いています。
...
コロナ禍の 2 年をのぞけば、最初の開催からずっと 2 泊 3 日の「合宿型」シンポジウムで、会場はだいたい箱根〜伊豆あたりの温泉地でした。コロナ禍前の 10 年弱は伊東が多かったですね。 2021 年と 2022 年は COVID-19 のためオンライン開催となりました。

そして 2023 年の第 64 回と 2024 年の第 65 回に引き続き、年明け 2025 年の第 66 回は、修善寺会場とオンライン会場のハイブリッド開催となります。第 66 回は会場の都合で、場所が大きく変わって那須になります。

https://prosym.org/66/

プログラミング・シンポジウムのハイブリッド開催は 2 回目となり、まだまだ試行錯誤が続いています。ここでは 2020 年までの現地会場開催をベースに、例年の様子を紹介します。
...
コロナ禍でのオンライン開催では、昼のプレゼンテーションに [Zoom](https://zoom.us/) を、自由討論を含む夜のセッション群には [SpatialChat](https://www.spatial.chat/) や [Gather](https://www.gather.town/) を使ったりしながら、どうにかこのプロシンの雰囲気の再現に苦慮していました。

COVID-19 が明けたと言われつつも感染は拡がりっぱなしの 2023 年の第 64 回と 2024 年の第 65 回では、コロナ禍前と同様の形で「夜の自由討論」を復活させるのはまだ難しそうでした。しかし次の第 66 回では会場も変わり、幹事団では、もう少しくらいいろいろやりたいよね、などと話しております。
...
* 第 65 回 (2024): 内山裕弥様 (国土交通省総合政策局/都市局)
...
https://prosym.org/66/cfp.html#type
...
https://prosym.org/66/cfp.html#comment
