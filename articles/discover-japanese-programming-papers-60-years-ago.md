...
さてこのプロシン、いちおう学会系のイベントなので、第 1 回から毎回いわゆる「論文集 (報告集・予稿集)」が出版されています。しかしこれまで、参加していなかった人が第 46 回 (2006 年) 以前の論文集にアクセスする方法はありませんでした。当時のシンポジウムに参加した人が持っている論文集 (物理冊子) しか、実質的に存在しなかったんですね。
