...
この最初期にあたる 1950 年代にはすでにプログラミングに触れていた人が、日本にもいなかったわけではもちろんありません。ですが、目的である科学技術計算や事務計算のための単なる「作業」ととらえられがちで、「プログラミングという営為」そのものに特に注目して活動をすることは多くなかったようです。

そんな中で 1960 年 1 月に第 1 回がおこなわれたのが、「プログラミング・シンポジウム」 (通称プロシン) です。 [^beginning-of-prosym] 「プログラミングそのものを興味の対象としたイベント」は、日本ではこれがおそらく最初のものだったと思われます。 [^first-programming-event]
...
[^first-programming-event]: 2024 年現在の日本でプログラミングをあつかう団体、特に学会としては、まず[情報処理学会](https://www.ipsj.or.jp/index.html)と[ソフトウェア科学会](https://www.jssst.or.jp/)が挙がります。その中で古い方である情報処理学会でも、その設立総会は 1960 年 4 月だったそうです。「[情報処理学会60年のあゆみ](https://www.ipsj.or.jp/60anv/60nenshi/1-1-1-1.html)」より。

プロシンは今でも続いていて、年明けの 2025 年には第 66 回を数えます。今のプロシンのご紹介は、以下の記事などをご覧ください。 (第 66 回の論文・発表も絶賛募集中です!)
...
さてこのプロシン、いちおう学会系のイベントなので、第 1 回から毎回いわゆる「論文集 (報告集・予稿集)」が出版されています。しかしこれまで、第 46 回 (2006 年) 以前の論文集にはアクセスする方法がありませんでした。当時のシンポジウムに参加した人が持っている論文集 (物理冊子) しか、実質的に存在しなかったんですね。

情報処理学会が直接かかわっていた論文や会誌「情報処理」の記事などは、スキャンしたものが最初期分から「[情報学広場](https://ipsj.ixsq.nii.ac.jp/ej/)」 (情報処理学会の電子図書館) に掲載されています。 [^jouhou-shori-vol-1] しかし長い間、プロシンの論文は第 47 回以降のものしか掲載がありませんでした。 [^prosym-digital-library]
...
そこで 2020 年、千葉大学の辻尚史先生に音頭を取っていただき、過去のプログラミング・シンポジウム論文集の内容を情報処理学会の情報学広場に掲載する活動が始まりました。 [^past-reports-copyrights]
...
そこからさらなる年月を要してしまったのですが、論文集の冊子をお持ちだった先生方からスキャンをご提供いただき、さらに多くの方々のご協力を得て PDF やタイトル・著者の確認と PDF の分割などをおこない、ようやく第 46 回以前のプロシンの論文集もすべて情報学広場に掲載するめどが立ちました。 [^as-of-2024-09-21]
...
[^aurhor-this-article]: 本記事の筆者は、データ・チェックや PDF 分割の取りまとめと最終確認の役をやっておりました。

学会系のイベントだからといって決してカタすぎることのない、ただただ「プログラミングが好きな」人たちが自由闊達にいろいろな (好き勝手な) 議論をしている様子が目に浮かぶような、当時の息吹を感じられるおもしろい記録になっていると思います。ぜひアクセスしてみてください!
...
…と、概要だけ紹介して終わりにしてもいいんですが、これだけで興味を持ってもらえる人は、あまり多くないかもしれません。

ということでここからは、本記事の筆者が掲載作業を進める中で [^survey-all] 「おもしろ!」と思った論文を、あくまで筆者の独断と偏見で (ひとまず第 1 回 (1960) 〜第 20 回 (1979) のなかから) ピックアップしてご紹介してみたいと思います。

[^survey-all]: なにせ、ほぼ全部に目は通しましたので…。

筆者の趣味が多分に反映されることをお許しください。 (カッコ () はシンポジウムの回数と開催年)
...
1 月に開かれるプロシンの分科会 (?) 的なあつかいで、いまでも「夏のプログラミング・シンポジウム」 (通称: 夏プロ) というのが夏に開かれています。 (この記事を公開した 2024 年 9 月 21 日も「[夏のプログラミング・シンポジウム 2024](https://prosym.org/sprosym2024/)」がおこなわれている最中です)
