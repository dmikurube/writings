...
後半で話したような「基盤ソフトウェア」を仕事にする人はあまり多くないかもしれませんが、そういう仕事には就かなくても、ほとんどの仕事ではなにかしらの基盤ソフトウェア使うでしょう。その基盤ソフトウェアを開発・メンテナンスしているのもやはり「人」であり、互換性などそれぞれの事情を抱えながら開発をしています。そのことを想像すると、基盤ソフトウェアをよりよく使うこと、そして必要なときによいコミュニケーションを取ることができるかもしれません。
