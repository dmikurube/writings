...
良い部品として安定・継続するためには、この Core Team のような形式のほうが、「中の人」がついうっかり勢いあまってぶっ壊れるよりも合っているでしょう。私としても、あまり画期的なことをいまから Embulk というエコシステムの中でやろうとは思っていません。 (Data Lineage 対応とか、レポーティングとか、キーになりそうな基盤機能については構想がないわけではないのですが)
...
なるべく手間がかからないようにしながら、このようにどうにかメンテナンスを継続していますが、今も「メンテナー」が私一人であることに変わりません。ここまで読んできてもらえた方なら、たとえば私が同僚に「あとはまかせた!」といきなり丸投げしても、メンテナーとして機能しないだろうということは想像できると思います。メンテナーの主な役割は、コミュニティ (主に Core Team) とのコミュニケーションと、過去の経緯やプラグイン環境を踏まえた意思決定です。つまりコミュニティと構築してきた信頼関係がとても重要です。コミット権を渡して一ヶ月でコードの説明をしただけでは、残念ながら信頼関係は引き継げません。
