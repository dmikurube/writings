...
ただこれは、新機能の提案のような一過性の貢献を募集するものではありません。「プルリクエストお待ちしてます!」のようなノリではありませんし、「この『俺の考えた最強の○○』を入れるべき!」のような一方的な提案は求めていません。ひとたびプラグイン互換性やデータの正確性に影響しようものなら、あとの対処が非常に大変ですし、そうして入ってしまった機能をずっとメンテナンスし続けるのはメンテナーなのです。
