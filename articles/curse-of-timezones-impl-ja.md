...
最初に検討するのは、時刻の内部データ表現をどうするか、すなわちソフトウェアの中で時刻データをどういう形式で保持するか、です。次の三点から検討を始めるといいでしょう。
...
時刻データを、常に「Unix time に変換可能」な形式で、言い換えると「その時刻が世界共通の時間軸のどこにあたるのかがわかる」形式で保持しておくことが、タイムゾーンの呪いを軽減するための基本戦略です。
