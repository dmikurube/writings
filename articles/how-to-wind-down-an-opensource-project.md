...
実際 Embulk にも、確実な証拠や確信こそ無いものの、「これは攻撃だったんだろうな」という事例はありました。

~~これについては別の記事にまとめているところで、数日中には公開したいと思っています。 (公開次第、本記事のこの部分も更新します)~~

「数日中には」と言っていたのに一年近くが経ってしまいましたが、このときの事例についての記事を公開しました。

@[card](https://zenn.dev/dmikurube/articles/a-logresearch-er)
