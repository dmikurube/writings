...
どんな会社のどんな組織にも、その会社の「悪いクセ」というのがあるものですよね。そのクセがその組織の強みの裏返しだったりもするので、一言で否定できるものでもありませんが。
...
ここで重要な学びはなんでしょうか。それは「ビジネスのインターフェース」のライフサイクル (寿命) と、「テクニカルなインターフェース」のライフサイクルにはズレがある、ということです。そして「オープンソースのインターフェース」のライフサイクルともなれば、ズレはさらに大きくなります。
