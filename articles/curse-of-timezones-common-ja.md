...
2021 年 〜 2022 年にかけて、夏時間制そのものを終わらせようという議論が、世界各国で現実的に進みはじめました。ソフトウェア・エンジニアとしては、両手を挙げて歓迎したい話のように聞こえます。…が。

夏時間制が本当に終わるとき、なにが起こるのか? それを本記事中の一節におさめるには、どうやら長くなりすぎたため、本記事の補遺として「[サマータイム制度の終わり 〜 そのときなにが起こるのか](./daylight-saving-time-discontinued-ja)」という別記事にまとめました。

@[card](https://zenn.dev/dmikurube/articles/daylight-saving-time-discontinued-ja)
